...
class data_realsr_canon_x2_train(image_dataset_patches_from_file):
    def __init__(self,
        ...
        super(data_realsr_canon_x2_train, self).__init__(source_path, target_path, ref_path, source_mask=source_mask, target_mask=target_mask, ref_mask=ref_mask)

class data_realsr_canon_x3_train(image_dataset_patches_from_file):
    def __init__(self,
        ...
        super(data_realsr_canon_x3_train, self).__init__(source_path, target_path, ref_path, source_mask=source_mask, target_mask=target_mask, ref_mask=ref_mask)

class data_realsr_canon_x4_train(image_dataset_patches_from_file):
    def __init__(self,
        ...
        super(data_realsr_canon_x4_train, self).__init__(source_path, target_path, source_mask=source_mask, target_mask=target_mask, ref_mask=ref_mask)        

class data_imagenet(image_dataset_patches_from_file):
    def __init__(self,
        ...
        super(data_imagenet, self).__init__(source_path, target_path, ref_path)


class data_div2k_x2_train(image_dataset_patches_from_file):
    def __init__(self,
                 ...
                 patch_size=(256,256), ref_scale=2, normalize=False, source_mask=False, target_mask=False, ref_mask=False):
        super(data_div2k_x2_train, self).__init__(source_path, target_path, ref_path)
        
class data_div2k_x3_train(image_dataset_patches_from_file):
    def __init__(self,
        ...
        super(data_div2k_x3_train, self).__init__(source_path, target_path, ref_path)
        
class data_div2k_x4_train(image_dataset_patches_from_file):
    def __init__(self,
        ...
        super(data_div2k_x4_train, self).__init__(source_path, target_path, ref_path)        
        
class data_bsd100_x2(image_dataset_patches_from_file):
    def __init__(self,
                 source_path = './data/benchmark/B100/LR_bicubic/X2',
                 target_path = './data/benchmark/B100/LR_bicubic/X2',
                 ref_path = './data/benchmark/B100/HR',
                 patch_size=(256,256), ref_scale=2, normalize=False, source_mask=False, target_mask=False, ref_mask=False):
        super(data_bsd100_x2, self).__init__(source_path, target_path, ref_path)

class data_bsd100_x3(image_dataset_patches_from_file):
    def __init__(self,
                 source_path = './data/benchmark/B100/LR_bicubic/X3',
                 target_path = './data/benchmark/B100/LR_bicubic/X3',
                 ref_path = './data/benchmark/B100/HR',
                 patch_size=(256,256), ref_scale=3, normalize=False, source_mask=False, target_mask=False, ref_mask=False):
        super(data_bsd100_x3, self).__init__(source_path, target_path, ref_path)

class data_bsd100_x4(image_dataset_patches_from_file):
    def __init__(self,
                 source_path = './data/benchmark/B100/LR_bicubic/X4',
                 target_path = './data/benchmark/B100/LR_bicubic/X4',
                 ref_path = './data/benchmark/B100/HR',
                 patch_size=(256,256), ref_scale=4, normalize=False, source_mask=False, target_mask=False, ref_mask=False):
        super(data_bsd100_x4, self).__init__(source_path, target_path, ref_path)


class data_manga109_x2(image_dataset_patches_from_file):
    def __init__(self,
                 source_path = './data/benchmark/Manga109/LR_bicubic/X2',
                 target_path = './data/benchmark/Manga109/LR_bicubic/X2',
                 ref_path = './data/benchmark/Manga109/HR',
                 patch_size=(256,256), ref_scale=2, normalize=False, source_mask=False, target_mask=False, ref_mask=False):
        super(data_manga109_x2, self).__init__(source_path, target_path, ref_path)        

class data_manga109_x3(image_dataset_patches_from_file):
    def __init__(self,
                 source_path = './data/benchmark/Manga109/LR_bicubic/X3',
                 target_path = './data/benchmark/Manga109/LR_bicubic/X3',
                 ref_path = './data/benchmark/Manga109/HR',
                 patch_size=(256,256), ref_scale=3, normalize=False, source_mask=False, target_mask=False, ref_mask=False):
        super(data_manga109_x3, self).__init__(source_path, target_path, ref_path)        

class data_manga109_x4(image_dataset_patches_from_file):
    def __init__(self,
                 source_path = './data/benchmark/Manga109/LR_bicubic/X4',
                 target_path = './data/benchmark/Manga109/LR_bicubic/X4',
                 ref_path = './data/benchmark/Manga109/HR',
                 patch_size=(256,256), ref_scale=4, normalize=False, source_mask=False, target_mask=False, ref_mask=False):
        super(data_manga109_x4, self).__init__(source_path, target_path, ref_path)        
...
class data_set5_x2(image_dataset_patches_from_file):
    def __init__(self,
                 ...
                 patch_size=(256,256), ref_scale=2, normalize=False, source_mask=False, target_mask=False, ref_mask=False):
        super(data_set5_x2, self).__init__(source_path, target_path, ref_path)        

class data_set5_x3(image_dataset_patches_from_file):
    def __init__(self,
                 source_path = './data/benchmark/Set5/LR_bicubic/X3',
                 target_path = './data/benchmark/Set5/LR_bicubic/X3',
                 ref_path = './data/benchmark/Set5/HR',
                 patch_size=(256,256), ref_scale=3, normalize=False, source_mask=False, target_mask=False, ref_mask=False):
        super(data_set5_x3, self).__init__(source_path, target_path, ref_path)        

class data_set5_x4(image_dataset_patches_from_file):
    def __init__(self,
                 source_path = './data/benchmark/Set5/LR_bicubic/X4',
                 target_path = './data/benchmark/Set5/LR_bicubic/X4',
                 ref_path = './data/benchmark/Set5/HR',
                 patch_size=(256,256), ref_scale=4, normalize=False, source_mask=False, target_mask=False, ref_mask=False):
        super(data_set5_x4, self).__init__(source_path, target_path, ref_path)        

        
class data_set14_x2(image_dataset_patches_from_file):
    def __init__(self,
                 source_path = './data/benchmark/Set14/LR_bicubic/X2',
                 target_path = './data/benchmark/Set14/LR_bicubic/X2',
                 ref_path = './data/benchmark/Set14/HR',
                 patch_size=(256,256), ref_scale=2, normalize=False, source_mask=False, target_mask=False, ref_mask=False):
        super(data_set14_x2, self).__init__(source_path, target_path, ref_path)

class data_set14_x3(image_dataset_patches_from_file):
    def __init__(self,
                 source_path = './data/benchmark/Set14/LR_bicubic/X3',
                 target_path = './data/benchmark/Set14/LR_bicubic/X3',
                 ref_path = './data/benchmark/Set14/HR',
                 patch_size=(256,256), ref_scale=3, normalize=False, source_mask=False, target_mask=False, ref_mask=False):
        super(data_set14_x3, self).__init__(source_path, target_path, ref_path)        

class data_set14_x4(image_dataset_patches_from_file):
    def __init__(self,
                 source_path = './data/benchmark/Set14/LR_bicubic/X4',
                 target_path = './data/benchmark/Set14/LR_bicubic/X4',
                 ref_path = './data/benchmark/Set14/HR',
                 patch_size=(256,256), ref_scale=4, normalize=False, source_mask=False, target_mask=False, ref_mask=False):
        super(data_set14_x4, self).__init__(source_path, target_path, ref_path)        

class data_urban100_x2(image_dataset_patches_from_file):
    def __init__(self,
                 source_path = './data/benchmark/Urban100/LR_bicubic/X2',
                 target_path = './data/benchmark/Urban100/LR_bicubic/X2',
                 ref_path = './data/benchmark/Urban100/HR',
                 patch_size=(256,256), ref_scale=2, normalize=False, source_mask=False, target_mask=False, ref_mask=False):
        super(data_urban100_x2, self).__init__(source_path, target_path, ref_path)

class data_urban100_x3(image_dataset_patches_from_file):
    def __init__(self,
                 source_path = './data/benchmark/Urban100/LR_bicubic/X3',
                 target_path = './data/benchmark/Urban100/LR_bicubic/X3',
                 ref_path = './data/benchmark/Urban100/HR',
                 patch_size=(256,256), ref_scale=3, normalize=False, source_mask=False, target_mask=False, ref_mask=False):
        super(data_urban100_x3, self).__init__(source_path, target_path, ref_path)        

class data_urban100_x4(image_dataset_patches_from_file):
    def __init__(self,
                 source_path = './data/benchmark/Urban100/LR_bicubic/X4',
                 target_path = './data/benchmark/Urban100/LR_bicubic/X4',
                 ref_path = './data/benchmark/Urban100/HR',
                 patch_size=(256,256), ref_scale=4, normalize=False, source_mask=False, target_mask=False, ref_mask=False):
        super(data_urban100_x4, self).__init__(source_path, target_path, ref_path)        
